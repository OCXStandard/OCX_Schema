...
class BuilderInformationT:
    ...
    class Meta:
        ...
        target_namespace = "https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd"
...
class Description:
    ...
    """
    class Meta:
        namespace = "https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd"
...
class RefTypeValue(Enum):
    ...
    """
    OCX_PANEL = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Panel")
    OCX_PLATE = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Plate")
    OCX_SEAM = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Seam")
    OCX_BRACKET = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Bracket")
    OCX_STIFFENER = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Stiffener")
    OCX_PILLAR = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Pillar")
    OCX_CONNECTION_CONFIGURATION = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}ConnectionConfiguration")
    OCX_HOLE2_D = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Hole2D")
    OCX_GRID_REF = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}GridRef")
    OCX_MATERIAL = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Material")
    OCX_BAR_SECTION = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}BarSection")
    OCX_CELL = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Cell")
    OCX_VESSEL = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Vessel")
    OCX_FREE_EDGE_CURVE3_D = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}FreeEdgeCurve3D")
    OCX_SURFACE = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Surface")
    OCX_END_CUT = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}EndCut")
    OCX_OCCURRENCE_GROUP = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}OccurrenceGroup")
    OCX_EDGE_REINFORCEMENT = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}EdgeReinforcement")
    OCX_HOLE2_DCONTOUR = QName("{https://3docx.org/fileadmin//ocx_schema//V300b2//OCX_Schema.xsd}Hole2DContour")
