__all__ = [
    ...
    "MetallicMaterial",
    "MetallicMaterialT",
    "MinimumBallastDraught",
    "MinorAxis",
    "MinorDiameter",
    "MouldedBreadth",
    "MouldedCenterOfGravity",
    "MouldedDepth",
    "MouldedDryWeight",
    "Nurbs3D",
    "Nurbs3DT",
    ...
    "StowageFactor",
    "StowageHeight",
    "StrEdgeReinforcementRef",
    "StrEdgeReinforcementRefT",
    "StrSeamRef",
    "StrSeamRefT",
    "StrStiffenerRef",
    "StrStiffenerRefT",
    ...
    "UnitsMltype",
    "Unose",
    "UnweldedTensileStrength",
    "UnweldedYieldStrength",
    "UpperDeckArea",
    "UpperRadius",
